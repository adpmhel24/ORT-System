...
from app.schemas.token_schema import TokenRead, Token
from app.schemas.response_schema import IPostResponseBase, http_response
...
#     return http_response(data=data, message="New password generated")
